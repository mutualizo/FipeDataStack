...
class FipeApiStack(NestedStack):
    def __init__(self, scope: Construct, construct_id: str, 
        ...
        manufacturer_lambda = lambda_.Function(
            ...
            code=lambda_.Code.from_asset("code_lambdas", exclude=["__pycache__", "*.pyc"]),
            handler="src/fipe_api/fipe_manufacturer_loader.lambda_handler",
        ...
        model_lambda = lambda_.Function(
            ...
            runtime=lambda_.Runtime.PYTHON_3_10,
            code=lambda_.Code.from_asset("code_lambdas", exclude=["__pycache__", "*.pyc"]),
            handler="src/fipe_api/fipe_model_loader.lambda_handler",
            timeout=Duration.minutes(5),
            memory_size=256,
        ...
        price_lambda = lambda_.Function(
            ...
            runtime=lambda_.Runtime.PYTHON_3_10,
            code=lambda_.Code.from_asset("code_lambdas", exclude=["__pycache__", "*.pyc"]),
            handler="src/fipe_api/fipe_price_loader.lambda_handler",
            timeout=Duration.minutes(5),
            memory_size=256,
        ...
        ingestor_lambda = lambda_.Function(
            ...
            runtime=lambda_.Runtime.PYTHON_3_10,
            code=lambda_.Code.from_asset("code_lambdas", exclude=["__pycache__", "*.pyc"]),
            handler="src/fipe_api/fipe_soma_ingestor.lambda_handler",  # Nome do handler corrigido
            timeout=Duration.minutes(5),
            memory_size=512,
